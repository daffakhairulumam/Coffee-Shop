...
$Daffa_sql = "SELECT * FROM t_meja WHERE id_meja = $Daffa_id";
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="logic/meja/updatee.php" method="post">

                            <div class="form-group mb-3">
                                <input type="hidden" name="id_meja" value="<?= $Daffa_id ?>" placeholder="Input ID" class="form-control">
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select class="form-control" name="status" required>
                                    ...
                                    <option value="Tersedia" <?= ($Daffa_data['status'] == 'Tersedia') ? 'selected' : '' ?>>Tersedia</option>
                                    <option value="Tidak Tersedia" <?= ($Daffa_data['status'] == 'Tidak Tersedia') ? 'selected' : '' ?>>Tidak Tersedia</option>
                                </select>
                            </div>
