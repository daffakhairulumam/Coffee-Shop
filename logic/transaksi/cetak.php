...
$pdf->Cell(0, 3, 'Username : ' . $Daffa_nama_user, 0, 1, 'L');
...
$pdf->Cell(0, 3, 'Total Bayar: ' . $value['jumlah_bayar'], 0, 1, 'R');
$pdf->Cell(0, 3, 'Kembalian: ' . $value['jumlah_bayar'] - $value['total_transaksi'], 0, 1, 'R');
