    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="index_manajer.php?page=kategori">Kategori</a></li>
                    ...
                    <div class="card-body">
                        ...
                        <form action="logic/kategori/save.php" method="post" class="">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="kode_kategori" placeholder="Input Kode Kategori" class="form-control" value="<?= $CodeKategori ?>" readonly>
                            </div>
