                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="text-end mb-3">
                            <a href="index_manajer.php?page=meja/create">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="index_manajer.php?page=meja/edit&id=<?= $value['id_meja'] ?>">
                                                <button type="button" class="btn btn-success">
                                                    Edit
                                                </button>
                                            </a>
                                            <a href="logic/meja/delete.php?id=<?= $value['id_meja'] ?>" onclick="javascript:return confirm('Hapus Data Barang ?');">
