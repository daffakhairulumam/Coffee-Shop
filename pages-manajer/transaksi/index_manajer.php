                        ...
                        <div class="row mb-3">
                            <div class="col-lg-6">
                                <div class="input-group">
                                    ...
                                    <select class="form-select" name="kode_menu" id="kode_menu">
                                        <option value="">--Pilih--</option>
                                        <?php foreach ($dataMenu as $menu) { ?>
                                            <option value="<?= $menu['kode_menu'] ?>"><?= $menu['kode_menu'] ?> - <?= $menu['nama_menu'] ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-lg-6">
                                <div class="input-group">
                                    ...
                                    <select class="form-select" name="kode_meja" id="kode_meja">
                                        <option value="">--Pilih--</option>
                                        <?php foreach ($dataMeja as $meja) : ?>
                                            <option value="<?= $meja['nomor_meja'] ?>"><?= $meja['keterangan'] ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
